    ...
    <body>
        ...
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li><a href="/admin/panel/edit">Description</a> <span class="divider">/</span></li>
                <li class="active"><?php echo substr($_GET["view"], 0, -4); ?></li>
            </ul>

            <form class="form-inline" action="edit.php" method="get">
                <textarea style="width: 100%; height: 300px;" id="cssNew" name="cssNew"><?php echo file_get_contents("../../../../content/".$_GET["view"]."/description.txt"); ?></textarea>&nbsp;<br/>
