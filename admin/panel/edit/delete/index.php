    ...
    <body>
        ...
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li><a href="/admin/panel/edit">Delete Album</a> <span class="divider">/</span></li>
                <li class="active"><?php echo substr($_GET["view"], 0, -4); ?></li>
            </ul>

            <form class="form-inline" action="edit.php" style="text-align: center;" method="get">
                Are you sure you want to delete this album? It'll be gone forever! <span class="muted">(that's a long time!)</span><br/>
                <input type="text" id="albumName" name="albumName" value="<?php echo $_GET["view"]; ?>"><br/>
