    ...
    <body>
        ...
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li><a href="/admin/panel/edit">Cover Image</a> <span class="divider">/</span></li>
                <li class="active"><?php echo substr($_GET["view"], 0, -4); ?></li>
            </ul>

            <form class="form-inline" action="edit.php" method="get">
                <div class="input-prepend">
                    <span class="add-on">Featured Image Within Album</span>
                    <input type="text" style="width: 100%;" id="cssNew" name="cssNew" value="<?php echo file_get_contents("../../../../content/".$_GET["view"]."/cover.txt"); ?>">
                </div>&nbsp;<p/>
                <div class="input-prepend">
