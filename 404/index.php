...
<html lang="en">
    <head>
        ...
        <title><?php echo siteName." &middot; 404"; ?></title>
    </head>
    <body>
        ...
        <div class="container">
            ...
            <span class="muted">404 Error.</span> Whatever you were looking for, it wasn't there. Sorry! There's nothing to do now but <a href="/">go home.</a>
        </div>
